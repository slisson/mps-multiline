...
public class SelectWordRight_Action extends BaseAction {
  ...
  protected static Log log = LogFactory.getLog(SelectWordRight_Action.class);
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    //  similar to SelectRight action from MPS. Most probably this case should be handled there in future 
  ...
  public void doUpdate(@NotNull AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (log.isErrorEnabled()) {
        log.error("User's action doUpdate method failed. Action:" + "SelectWordRight", t);
      }
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    try {
      ...
      if (log.isErrorEnabled()) {
        log.error("User's action execute method failed. Action:" + "SelectWordRight", t);
      }
    }
  }
}
